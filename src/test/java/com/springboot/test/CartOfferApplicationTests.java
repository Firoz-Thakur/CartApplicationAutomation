...
public class CartOfferApplicationTests {
    ...
    public void testFlatxAmountOff(String testCaseTitle, int userId, int cartValue, int restaurantId, double expectedCartValue, String offerType, int offerValue) throws Exception {
    ...
    public void testFlatxPercentageOff(String testCaseTitle, int userId, int cartValue, int restaurantId, double expectedCartValue, String offerType, int offerValue) throws Exception {
